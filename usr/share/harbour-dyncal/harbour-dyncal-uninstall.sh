...
cp /usr/share/harbour-dyncal/default.png /usr/share/themes/jolla-ambient/meegotouch/z1.0/icons/icon-launcher-calendar.png
...
desktop-file-install /usr/share/applications/jolla-calendar.desktop --set-icon=/usr/share/themes/jolla-ambient/meegotouch/z1.0/icons/icon-launcher-calendar.png
exit 0